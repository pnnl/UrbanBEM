...
def populate_std_schedules(case: Dict, randomize: bool) -> Dict:
	...
	"""
	bldg_business_hour_dict, consider_lunch_time = sp.bldg_business_hour(case, randomize)
	...
	bldg_light_sch_dict = sp.bldg_light_sch(bldg_business_hour_dict, consider_lunch_time)
	bldg_hvac_operation_sch_dict = sp.bldg_hvac_operation_sch(bldg_business_hour_dict, consider_lunch_time)
